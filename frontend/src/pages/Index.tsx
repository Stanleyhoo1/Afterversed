  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div 
        ...
        style={{
          background: 'radial-gradient(circle, hsl(var(--color-soft-taupe)) 0%, transparent 70%)',
        }}
      />
      ...
      <div className="relative z-10 container mx-auto px-4 py-12 flex flex-col items-center justify-center min-h-screen">
        <div className="w-full max-w-4xl">
          ...
          <div className="relative">
            {/* Avatar circle */}
            <div className="absolute -left-4 top-0 w-24 h-24 rounded-full bg-secondary shadow-lg md:-left-8 md:w-32 md:h-32"></div>
            
            {/* Speech bubble */}
            <div className="ml-24 bg-card rounded-3xl shadow-2xl p-8 md:ml-32 md:p-12 relative">
              {/* Speech bubble tail */}
              <div className="absolute -left-6 top-8 w-0 h-0 border-t-[20px] border-t-transparent border-r-[30px] border-r-[hsl(var(--color-soft-taupe))] border-b-[20px] border-b-transparent"></div>
